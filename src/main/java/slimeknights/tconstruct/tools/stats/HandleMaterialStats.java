...
public class HandleMaterialStats extends BaseMaterialStats {
  ...
  private static final Component DURABILITY_DESCRIPTION = makeTooltip(Util.getResource("handle.durability.description"));
  private static final Component ATTACK_DAMAGE_DESCRIPTION = makeTooltip(Util.getResource("handle.attack_damage.description"));
  private static final Component ATTACK_SPEED_DESCRIPTION = makeTooltip(Util.getResource("handle.attack_speed.description"));
  private static final Component MINING_SPEED_DESCRIPTION = makeTooltip(Util.getResource("handle.mining_speed.description"));
