...
public class GuiFuelModule {
  ...
  private static final List<Component> TOOLTIP_NO_TANK = Collections.singletonList(new TranslatableComponent(Util.makeTranslationKey("gui", "melting.fuel.no_tank")));
  private static final List<Component> TOOLTIP_NO_FUEL = Collections.singletonList(new TranslatableComponent(Util.makeTranslationKey("gui", "melting.fuel.empty")));
  private static final Component TOOLTIP_INVALID_FUEL = new TranslatableComponent(Util.makeTranslationKey("gui", "melting.fuel.invalid")).withStyle(ChatFormatting.RED);
  private static final Component TOOLTIP_SOLID_FUEL = new TranslatableComponent(Util.makeTranslationKey("gui", "melting.fuel.solid"));
