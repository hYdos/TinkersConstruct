...
public class TableModel implements IModelGeometry<TableModel> {
  ...
  public net.minecraft.client.resources.model.BakedModel bake(IModelConfiguration owner, ModelBakery bakery, Function<Material,TextureAtlasSprite> spriteGetter, ModelState transform, ItemOverrides overrides, ResourceLocation location) {
    net.minecraft.client.resources.model.BakedModel baked = this.model.bakeModel(owner, transform, overrides, spriteGetter, location);
  ...
  public static class BakedModel extends RetexturedModel.BakedModel {
    @Getter
    private final List<ModelItem> items;
    protected BakedModel(net.minecraft.client.resources.model.BakedModel baked, IModelConfiguration owner, SimpleBlockModel model, ModelState transform, Set<String> retextured, List<ModelItem> items) {
