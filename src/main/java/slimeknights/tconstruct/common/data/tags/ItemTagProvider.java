...
public class ItemTagProvider extends ItemTagsProvider {
  ...
  private void addCommon() {
    ...
    this.tag(TinkerTags.Items.EARTH_SLIMEBALL).add(Items.SLIME_BALL);
    this.tag(TinkerTags.Items.SKY_SLIMEBALL).add(TinkerCommons.slimeball.get(SlimeType.SKY));
    this.tag(TinkerTags.Items.ENDER_SLIMEBALL).add(TinkerCommons.slimeball.get(SlimeType.ENDER));
    this.tag(TinkerTags.Items.BLOOD_SLIMEBALL).add(TinkerCommons.slimeball.get(SlimeType.BLOOD));
    this.tag(TinkerTags.Items.ICHOR_SLIMEBALL).add(TinkerCommons.slimeball.get(SlimeType.ICHOR));

    this.tag(Tags.Items.INGOTS).add(TinkerSmeltery.searedBrick.get(), TinkerSmeltery.scorchedBrick.get());
    this.tag(TinkerTags.Items.WITHER_BONES).add(TinkerModifiers.necroticBone.get());
  ...
  private void addTools() {
    ...
    // supports modifiers
    this.tag(TinkerTags.Items.MELEE_OR_HARVEST)
        .addTag(TinkerTags.Items.MELEE)
        .addTag(TinkerTags.Items.HARVEST);

    // special
    // support expanders
    this.tag(TinkerTags.Items.AOE)
        .add(TinkerTools.pickaxe.get(), TinkerTools.sledgeHammer.get(), TinkerTools.veinHammer.get(),
						 TinkerTools.mattock.get(), TinkerTools.excavator.get(),
						 TinkerTools.handAxe.get(), TinkerTools.broadAxe.get(),
						 TinkerTools.kama.get(), TinkerTools.scythe.get(),
						 TinkerTools.sword.get(), TinkerTools.cleaver.get());
    this.tag(TinkerTags.Items.ONE_HANDED)
    ...
    this.tag(TinkerTags.Items.TWO_HANDED)
    ...
    this.tag(TinkerTags.Items.MULTIPART_TOOL)
        .add(TinkerTools.pickaxe.get(), TinkerTools.sledgeHammer.get(), TinkerTools.veinHammer.get(),
             TinkerTools.mattock.get(), TinkerTools.excavator.get(),
             TinkerTools.handAxe.get(), TinkerTools.broadAxe.get(),
             TinkerTools.kama.get(), TinkerTools.scythe.get(),
    ...
    // general
    this.tag(TinkerTags.Items.MODIFIABLE)
